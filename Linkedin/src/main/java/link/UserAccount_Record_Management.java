...
public class UserAccount_Record_Management {
    ...
    public int register_account(){
        try{
            ...
            pstmt = conn.prepareStatement("INSERT INTO user_accounts (account_ID, first_name, last_name, contact_no, email, home_address, birthday, education, years_of_experience, primary_language, job_ID, company_ID, user_password, registration_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            pstmt.setDate(14, registrationDate);
